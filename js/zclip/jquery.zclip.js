/*
 * Created by chensheng.zcs on 16/12/14.
...
ZeroClipboard.Client.prototype = {
    ...
    getHTML: function(d, a) {
        ...
        // 这里为了兼容IE浏览器，有跨域调用，但是考虑到复制功能的flash效果不重要，而且很少去打开小功能，所以这里去掉跨域兼容IE的代码。
        // 如果需要再次兼容，打开注释部分即可。
        ...
        // }
        c += '<embed id="' + this.movieId + '" src="' + ZeroClipboard.moviePath + '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + d + '" height="' + a + '" name="' + this.movieId + '" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash"  flashvars="' + b + '" wmode="transparent" />'
        return c
    },
    hide: function() {
        if (this.div) {
